...
class PhCube(object):
    ...
    def gen_cuboids(self):
        ...
        for ld in range(len(self.dms) + 1):
            ...
            for cuboid in itertools.combinations(self.dms, ld):
    ...
    def gen_cuboids_data(self, cuboid):
        ...
        def gen_cuboid_name():
            ...
            return "apex" \
                ...
                else "base" if dimension_count == len(self.dms) \
        ...
        def gen_apex_lattice():
            all_hierarchies = self.get_all_hierarchies()
        ...
        if len(hierarchies) == 0:
            gen_apex_lattice()
        elif len(hierarchies) == len(self.dms):
            gen_base_lattice()
        else:
